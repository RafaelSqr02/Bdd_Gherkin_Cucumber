Feature: Test
Scenario: 01  - Pesquisando Flamengo no Globo Esporte
...
Scenario: 02 - Pesquisando Flamengo no Google e entrando no site do time
...
Scenario: 03 - Realizar Login no Sauce Demo
    Dado que o usuário logue no Sauce Demo
    Então Espero que meu Login seja validado

Scenario: 04 - Por todos os produtos no carrinho 
